<%@ Page Title="Home Page" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.vb" Inherits="Trabajoclase._Default" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <main>
        <section class="row" aria-labelledby="aspnetTitle">
            ...
            <p class="lead">
                <asp:Label ID="Lblpersona" runat="server" Text="Label"></asp:Label>

            </p>
            <p><a href="https://github.com/JJ-star720" class="btn btn-primary btn-md">Github;</a></p>
        </section>
